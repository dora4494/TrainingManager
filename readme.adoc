...
Vous pouvez consulter les principaux link:ihm/index.html[parcours utilisateur] de l'application.
...
Si vous souhaitez démarrer l'application et les tests sous docker, vous trouverez des indications sur cette page: link:docker.html[Docker]