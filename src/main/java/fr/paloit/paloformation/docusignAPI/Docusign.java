...
//      return new InformationsUtilisateur(signerEmail, signerName, ccEmail, ccNom);
       return new InformationsUtilisateur("pandora.pierrot@gmail.com","Pierrot"," "," ");
   }
...
public void envoyerEnveloppe(Utilisateur utilisateur) throws IOException {
 ...
 try {
      ...
      // Set recipients
   // InformationsUtilisateur result = infosUtilisateur();
      Signer signer = new Signer();
      signer.setEmail(utilisateur.getMail());
      signer.setName(utilisateur.getNom());
   ...
   // public static void main(String[] args) throws IOException {
     //   new Docusign().envoyerEnveloppe(utilisateur);
   // }
